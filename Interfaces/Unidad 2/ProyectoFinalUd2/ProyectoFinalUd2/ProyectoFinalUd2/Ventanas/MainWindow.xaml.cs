...
namespace ProyectoFinalUd2
{
    ...
    public partial class MainWindow : Window
    {
        ...
        // Bandera para evitar bucle infinito al modificar texto por código (sin esto, al clicar algo explota todo)
        ...
        public MainWindow()
        {
            ...
            {
                MessageBox.Show("Error al iniciar la base de datos: " + ex.Message);
            }
        }
        ...
        // Carga los productos asociados a la categoría seleccionada
