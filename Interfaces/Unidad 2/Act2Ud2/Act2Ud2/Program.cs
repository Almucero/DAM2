...
namespace Act2Ud2
{
    ...
    public class Ejercicio9
    {
        ...
        public static void Ejecutar()
        {
            Console.WriteLine("Suma: " + EjecutarOperacion(Sumar, 10, 5));
            Console.WriteLine("Resta: " + EjecutarOperacion(Restar, 10, 5));
            Console.WriteLine("Multiplicación: " + EjecutarOperacion(Multiplicar, 10, 5));
        }
    }
    ...
    public class Ejercicio10
    {
        ...
        private static double RaizCuadrada(double x) => Math.Sqrt(x);
        private static double Logaritmo(double x) => Math.Log(x);
        public static void EjecutarOperacion(Calculo c, double valor)
        {
            try
            {
                double resultado = c(valor);
        ...
        public static void Ejecutar()
        {
            Console.WriteLine("Raíz cuadrada de 9:");
            EjecutarOperacion(RaizCuadrada, 9);
            Console.WriteLine("Logaritmo de 10:");
            EjecutarOperacion(Logaritmo, 10);
            Console.WriteLine("Raíz cuadrada de -4:");
            EjecutarOperacion(RaizCuadrada, -4);
        }
    }
}